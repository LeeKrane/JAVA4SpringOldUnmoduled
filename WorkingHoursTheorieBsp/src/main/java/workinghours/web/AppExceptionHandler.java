...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<String> handleWorkingHoursHasIdException (
			WorkingHoursHasIdException ex, WebRequest req) {
		return new ResponseEntity<>(ex.getMessage(), HttpStatus.BAD_REQUEST);
	}
	
	@ExceptionHandler(WorkingHoursNotFoundException.class)
	public ResponseEntity<String> handleWorkingHoursNotFoundException (
			WorkingHoursNotFoundException ex, WebRequest req) {
		return new ResponseEntity<>(ex.getMessage(), HttpStatus.NOT_FOUND);
	}
	
	@Override
	protected ResponseEntity<Object> handleMethodArgumentNotValid (
			MethodArgumentNotValidException manve, HttpHeaders hh, HttpStatus hs,
			WebRequest wr) {
		return new ResponseEntity<>("Validation failed: " + manve.getMessage(),
